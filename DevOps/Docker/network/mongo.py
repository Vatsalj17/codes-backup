...
try:
    client = MongoClient("mongodb://172.17.0.1:27017/", serverSelectionTimeoutMS=5000) # for connecting to local database of host(provided ip is of docker0 ip interface)
